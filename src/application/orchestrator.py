...
from presentation.cli import get_cities, show_results
...
def run():
    hardcoded_keywords = ["intern"]
    # should be user inputted keywords
    ...
    for company in companies:
        ...
        if company["career_page"] != "":
            ...
            if html != "" and search_matching_position(html, hardcoded_keywords):
